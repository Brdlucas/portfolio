  ...
  return (
    <main className='max-2xl:h-[1000px]'>
      <header className='max-2xl:h-[120px] md:h-[100px]'>
        <nav className='max-2xl:text-center max-2xl:p-[10px] font-bold md:absolute md:flex md:flex-row md:w-[25%] md:right-[250px] md:mt-8 items-center md:place-content-around'>
