...
export default function Contact() {
    ...
    const ActionFunc = (copyValue: any, copyText: any) => {
    ...
    const CopyElement = async (valueCopy: string, isEmail: boolean) => {
        ...
        copyValue && copyValue.classList.remove('bg-white');
        await ActionFunc(copyValue, copyText);
        copyValue && copyValue.classList.add('bg-white');
    }

    return (
        <div className='h-full m-auto flex align-middle justify-center flex-col gap-16 '>
            <div className={`w-10/12 m-auto max-lg:w-[90%] p-5 shadow-[-1px_4px_14px_7px_rgba(0,_0,_0,_0.1)] transition duration-300 rounded-4xl ${themeClass(
                "bg-gray-800",
                "bg-gray-50"
            )} `}>
            ...
            <div className={`w-10/12 m-auto max-lg:w-[90%] p-3 shadow-[-1px_4px_14px_7px_rgba(0,_0,_0,_0.1)] rounded-4xl  transition duration-300 ${themeClass(
                "bg-gray-800",
                "bg-gray-50"
            )}`} >
                ...
                <div className='flex m-5 gap-5 max-sm:flex-col  max-sm:justify-center justify-around'>
                    <Link target="_blank" href={''} className=' shadow-[-1px_4px_14px_7px_rgba(0,_0,_0,_0.1)] mx-auto max-w-100 hover:scale-102 transition duration-300 rounded-2xl h-fit bg-white'>
                        <img src="/img/about/github.webp" alt="" width={512} className='h-40 object-contain rounded-2x px-5' />
                    </Link>
                    <Link target="_blank" href={'https://profile.indeed.com/?hl=fr_FR&co=FR&from=gnav-homepage'} className=' mx-auto max-w-100 shadow-[-1px_4px_14px_7px_rgba(0,_0,_0,_0.1)] hover:scale-102 transition duration-300 rounded-2xl h-fit bg-white'>
                        <img src="/img/about/indeed.webp" alt="" width={512} className='h-40 object-contain rounded-2xl px-5' />
                    </Link>
                    <Link target="_blank" href={'https://www.linkedin.com/in/lucas-bourdon-97ba91240/'} className='mx-auto max-w-100 shadow-[-1px_4px_14px_7px_rgba(0,_0,_0,_0.1)] hover:scale-102 transition duration-300  rounded-2xl h-fit bg-white'>
