    ...
    return (
        <div className="w-[70%] m-auto h-full ">
            ...
            <section className="text-justify pt-5">
                <p>Après des études en systèmes numériques, j&apos;ai suivi une formation pour obtenir un diplôme de développeur web et web mobile de niveau 5 (équivalent à un bac +2). Au cours de cette formation, j&apos;ai acquis une solide maîtrise de plusieurs langages les plus connus tels que HTML (langage de balisage), CSS, et JavaScript, ainsi que des langages plus &ldquo;modernes&ldquo; comme Symfony et React <a className="text-purple-600" href="#language_id"> (détails ci-dessous)</a>.<br /> <br /> J&apos;ai également appris à utiliser Next.js,(React Framework avec laquelle j&apos;ai développé ce site web), lors d&apos;un stage de 2 mois. Passionné par l&apos;apprentissage en autodidacte, je suis constamment à la recherche de nouvelles connaissances et compétences. <br /> <br /> Je vous invite à aller voir mon CV crée en React sur lequelle je donne plus d&apos;information sur mon parcours scolaire ainsi que professionel.</p>
            </section>
            <section>
