                    ...
                    <div className='pl-[50px] flex  gap-x-20 flex-wrap mb-5'>
                        {
                            projects.map((project: any) => {
                                return (
                                    <div key={project._id} className="mt-5 bg-gray-200 drop-shadow-2xl shd w-[20%] max-xl:w-[25%] max-md:w-[35%] h-[300px] rounded-[25px]">
                                        ...
                                        <div className='pl-5 pt-2'>
                                            ...
                                            <p className='mt-5 h-16'>{project.description}</p>
                                            <Link target='_blank' href={project.link} className='block mt-2 w-[55%] text-center font-semibold text-[15px] text-white rounded-[20px] p-5 bg-purple-500'>Voir {project.title}</Link>
                                        </div>
                                    </div>
                                )
