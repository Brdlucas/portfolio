  ...
  return (
    <div className="md:pl-[50px] mt-5 max-md:pt-10 grid grid-cols-3 gap-20 max-md:gap-10 max-md:grid-cols-1 max-md:text-center mb-5 max-lg:grid-cols-2">
      {[...Array(6)].map((_, index) => (
        <div
          key={index}
          className="animate-pulse block m-auto drop-shadow-2xl bg-gray-100 shd w-[100%] h-full rounded-[25px] hover:rounded-[15px] hover:scale-110 duration-400 transition ease-in-out delay-150"
        >
